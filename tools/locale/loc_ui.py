...
U = [
 # --- strip chrome
 ("CONFIG_BANNER", "Choosing what to show","Auswahl der Anzeigen","Eligiendo qué mostrar","Choix des lectures","Scelta delle letture","表示する項目を選択中","표시할 항목 선택 중","Wybór odczytów","Escolhendo o que mostrar","Выбор показателей","正在选择显示项","正在選擇顯示項"),
